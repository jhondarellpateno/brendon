 ...
 * @author jhond
 */
public class addAddon extends javax.swing.JFrame {

    /**
     * Creates new form addAddon
     */
    public addAddon() {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Add Add-ons");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 362, -1));
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 190, 30));
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 190, 30));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Please enter a valid numeric price (e.g., 10.50)", "Format Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        try {
            String sql = "INSERT INTO addons (a_name, a_price) VALUES (?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addAddon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
